              ...
              <div className="border bg-white">
                <div className="p-3 border-bottom bg-dark">
                  <h5 className="text-uppercase fw-semibold m-0 text-white">
                    ...
                    แบบฟอร์มแก้ไขการส่งต่อผู้เรียน
                  </h5>
                </div>
                <div className="p-3">
                  <form onSubmit={handleSubmit}>
                    <div className="row">
                      ...
                      <div className="col-md-6 mb-3">
                        <label className="form-label text-uppercase fw-semibold small">สถานะ</label>
                        <select 
                          className="form-select rounded-0"
                          value={form.status}
                          onChange={(e) => setForm({...form, status: e.target.value as "อยู่ระหว่างดำเนินการ" | "สิ้นสุดการช่วยเหลือ"})}
                        >
                    ...
                    <div className="row">
                      <div className="col-12">
                        <button type="submit" className="btn btn-warning rounded-0 text-uppercase fw-semibold me-2">
                          <i className="bi bi-save me-2"></i>บันทึกการแก้ไข
                        </button>
                        <button 
                          type="button" 
